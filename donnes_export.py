...
epreuves = ["Natation 100m brasse", "Natation 4x100m libre", "HandBall", "Volley-Ball", "Escrime fleuret", "Escrime épée", "Athétisme 110m haies", "Athlétisme 4x100m haies"]
sports = ["natation", "volley", "escrime", "athle", "hand"]
...
#    agilite = random.randint(1, 20)
    # print(f"Athlete athlete{i} = new Athlete(''{nom}'', ''{prenom}'', '{sexe}', {force}, {agilite}, {endurance}, {pays_choice}, {sport});")

epreuve = ["natation100mBrasseF", "natation100mBrasseH", "natation4x100mF", "natation4x100mH", "handFind", "handMind", "volleyFind", "volleyHind", "escrimeFfind", "escrimeFeind", "escrimeMfind", "escrimeMeind", "athle110mF", "athle110mH", "athle400mF", "athle400mH"]

for i in range(40):
    print(f"athlete{i}.ajouteResultat({random.randint(1,20)}, {random.choice(epreuve)});")
